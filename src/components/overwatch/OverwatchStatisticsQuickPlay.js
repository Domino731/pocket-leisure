...
import {
    ...
    OwLinksContainer,
    OwMedalBar,
    OwMedalsDiagram, OwPrivate, OwStatsColumns, OwStatsSingleColumn,
    OwStatsTable,
    OwStatsTitle,
    OwStatTitle,
    OwWonGamesBar
...
/**
 * Component with full stats for quick play mode
 * @returns {JSX.Element} - quick play overwatch stats
 */
export const OverwatchStatisticsQuickPlay = () => {
    ...
    useEffect(() => {
        return getOverwatchQuickPlayStats(platform,
            region,
            user,
            battleTag,
            setStats);
    ...
    return <Container>
        ...
        <OwLinksContainer>
            <OwLink>
                <Link
                    to={`/overwatch/stats-competitive/${platform}/${region}/${user}/${battleTag}`}>Competitive</Link>
            </OwLink>
            <OwLink>
                <Link
